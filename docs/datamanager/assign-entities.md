...
**Redirect with 301** and **Redirect with 410** actions. Applying a status preserves
statuses on previously processed rows. The selected status is carried per row to async;
async auto-selected redirects remain locked at status `301`.
